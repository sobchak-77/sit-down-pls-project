...
/* harmony import */ var _components_tags_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/_tags.js */ "./src/js/components/_tags.js");
/* harmony import */ var _components_catalog_list_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/_catalog-list.js */ "./src/js/components/_catalog-list.js");
...
/***/ "./src/js/components/_catalog-list.js":
/*!********************************************!*\
  !*** ./src/js/components/_catalog-list.js ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const sliderBtn = document.querySelectorAll('.slider-ctrl__btn');
const catalogList = document.querySelectorAll('.catalog__list');
sliderBtn.forEach(btn => {
  btn.addEventListener('click', ev => {
    let path = ev.currentTarget.dataset.path;

    // --- switch button from 'normal' to 'active' ---
    sliderBtn.forEach(btn => {
      btn.classList.remove('slider-ctrl__btn--active');
    });
    ev.currentTarget.classList.add('slider-ctrl__btn--active');

    // --- switch catalog list from 'hidden' to 'active' ---
    catalogList.forEach(list => {
      list.classList.remove('list-active');
      document.querySelector(`[data-target='${path}']`).classList.add('list-active');
    });
  });
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const tag = document.querySelectorAll('.tag__item');
const tagBtn = document.querySelectorAll('.tag__btn');
tagBtn.forEach(btn => {
  btn.addEventListener('click', () => {
    btn.closest('.tag__item').remove();
  });
});
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _comp_catalog_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_comp-catalog.js */ "./src/js/_comp-catalog.js");
